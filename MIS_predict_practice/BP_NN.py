...
class NeuralNetwork(object):
    ...
    def train(self, inputs_list, targets_list):
        ...
        # 向前传播，Forward pass
        # TODO: Hidden layer
        hidden_inputs = np.array(np.dot(self.weights_input_to_hidden, inputs), dtype=np.float32)  # signals into hidden layer
        ...
        self.weights_input_to_hidden = self.weights_input_to_hidden + (inputs * hidden_errors * self.lr).T
